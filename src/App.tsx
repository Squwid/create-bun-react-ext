...
export const App = () => (
  <main className="bg-slate-950 min-h-screen w-full flex flex-col items-center justify-center text-white">
    ...
    <p>
      Running in <span className="font-bold">{process.env.NODE_ENV}</span> mode,
      hot reloading is{' '}
      <span className="font-bold">
        {(globalThis as any)['ws'] === true ? 'enabled' : 'disabled'}
      </span>
    </p>
    ...
    <section>
      <p className="text-lg font-bold">What to do next</p>
      <ul className="list-[circle] mb-4">
        <li>
          <a
            className="border-b-2 border-yellow-200 border-dotted"
            href="https://github.com/gerardmarquinarubio/create-bun-react-app"
            target="blank"
          >
            Star this repo
          </a>
        </li>
        <li>Edit index.tsx</li>
        <li>
          <a
            className="border-b-2 border-yellow-200 border-dotted"
        ...
        <li>
          <a
            ...
            target="blank"
          >
            Read the TailwindCSS documentation
          </a>
        </li>
        <li>
          <a
      ...
      <p className="text-lg font-bold">Installed dependencies</p>
